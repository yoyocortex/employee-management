...
export default class Category extends Component {
    ...
    componentDidMount = async () => {
        ...
        await getCategoryList()
            .then((res) => this.setState({ categoryList: res, loading: false }))
    ...
    add = async (formData) => {
        await onSubmitNewCategory(formData)
            .then((res) => this.setState({ categoryList: res }))
            .then(this.errorNotify('success', 'Successfuly created a category.'))
            .catch((err) => this.errorNotify('error', err.message));
    }
    ...
    update = async (id, formData) => {
        await updateCategory(id, formData)
            .then((res) => this.setState({ categoryList: res }))
            .then(this.errorNotify('success', 'Successfuly updated a category.'))
            .catch((err) => this.errorNotify('error', err.message));
    }
    ...
    delete = async (id) => {
        await deleteCategory(id)
            .then((res) => this.setState({ categoryList: res }))
            .then(this.errorNotify('success', 'Successfuly deleted a category.'))
            .catch((err) => this.errorNotify('error', err.message));
    }
    ...
    render() {
        ...
        const { open, loading, categoryList } = this.state;
